          ...
          <form className="mt-7 space-y-4" onSubmit={submit}>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs" style={{ color: "#0F8F5F" }}>Forgot password?</Link>
              </div>
              <input type="password" value={pw} onChange={(e) => setPw(e.target.value)} required className="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200 text-sm outline-none focus:border-slate-300" placeholder="••••••••" />
            </div>
